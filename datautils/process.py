...
DATAROOT = "F:\\0_doctor\\BCSD\\dataset\\origin" # dir of pickle files saved by IDA
SAVEROOT = "F:\\0_doctor\\BCSD\\dataset\\extract" # dir of binaries (not stripped)
...
if __name__ == "__main__":
    ...
    print('[unstrip_path]', unstrip_path)
